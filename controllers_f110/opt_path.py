...
def get_path(currX, currY, currPhi, goalX, goalY, goalPhi, min_radius=0.33/np.tan(np.pi*25/180), iteration=0):
...
#	cost_sorted.sort()
	...
	if sign_curr*sign_goal>0:
		...
		print 'else',(curr_x**2 - 2*curr_x*goal_x + curr_y**2 - 2*curr_y*goal_y + goal_x**2 + goal_y**2)
